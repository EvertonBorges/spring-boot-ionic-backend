...
INSERT INTO `cidade` VALUES (1,'Uberlânlia',1),(2,'São Paulo',2),(3,'Campinas',2);
...
INSERT INTO `cliente` VALUES (1,'36378912377','ebke@hotmail.com','Maria Silva','$2a$10$tGo/8nFo7LJN7pnMJfKDxOZtPfaUaqpfyb4Zxun6rZ7pq3aqJmYE.',1),(2,'43035226008','esterbanico@gmail.com','Ana Costa','$2a$10$X1td.BaiSqN9/qibgKFZl.eednZuIHLWXQ0QJSnoJblC/D6yq0fKe',1);
...
CREATE TABLE `cliente_telefones` (
  ...
  KEY `FK55h0ud5ggf9e3wne0ldc9p4qu` (`cliente_id`),
  CONSTRAINT `FK55h0ud5ggf9e3wne0ldc9p4qu` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`)
...
INSERT INTO `cliente_telefones` VALUES (1,'27363323'),(1,'93838393'),(2,'93883321'),(2,'34252625');
...
CREATE TABLE `endereco` (
  ...
  KEY `FKey1y9x6lipoe7ius1lcmgbghe` (`endereco_id`),
  CONSTRAINT `FK8b1kcb3wucapb8dejshyn5fsx` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id`),
  CONSTRAINT `FKey1y9x6lipoe7ius1lcmgbghe` FOREIGN KEY (`endereco_id`) REFERENCES `cliente` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `endereco` VALUES (1,'Jardim','39220834','Apto 303','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Avenida Matos','105',2,1),(3,'Centro','28777012',NULL,'Avenida Floriano','2106',2,2);
...
INSERT INTO `item_pedido` VALUES (0,2000,1,1,1),(0,80,2,1,3),(100,800,1,2,2),(150,2000,3,3,1);
...
INSERT INTO `pagamento` VALUES (1,2),(2,1),(3,1);
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2019-10-20 04:00:00.000000',2);
...
INSERT INTO `pedido` VALUES (1,'2019-02-10 14:32:00.000000',1,1),(2,'2019-06-15 23:35:00.000000',1,2),(3,'2019-07-29 14:39:00.000000',NULL,NULL);
...
-- Dump completed on 2019-10-29 12:57:28
